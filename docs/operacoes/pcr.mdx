...
graph TD;
    ...
    verificar_idade --> |Não|posicionar_adulto[Ajoelhe-se ao lado do corpo\nColoque uma mão sobre a outra, entrelaçando os dedos de cima e os de baixo\nEstique os braços sem dobrar os cotovelos\nColoque a mão no meio do peito dele, na linha do mamilo]
    verificar_idade --> |Sim|posicionar_bebe[Coloque o bebê numa mesa ou no chão efique de frente pra ele\nSegure o corpo dele deixando\nos polegares na linha do mamilo]
    ...
    orientar_compressoes --> abrir_metronomo(Inicie o metrônomo abaixo e bata\npalmas no ritmo perto do fone para\norientar o solicitante):::atendente
    abrir_metronomo --> marcar_tempo(Faça o procedimento\npor 2 minutos):::atendente

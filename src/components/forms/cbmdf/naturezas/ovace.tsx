...
const Ovace = (props) => {
    ...
    return (
        <Grid>
            ...
            {emergencial &&
                <Grid>
                    <AlertMessage severity="info" title="Me confirme por favor. A pessoa está engasgada?"></AlertMessage>
                    <YesNoField value={confirmaOVACE} onChange={(value) => handleChange("confirmaOVACE", value)} />

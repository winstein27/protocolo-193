    ...
    <Grid>
      ...
      {emergencial && (
        <Grid>
          <AlertMessage
            severity="info"
            title='"Há pessoas próximas ao incêndio?"'
          />
          <YesNoField
            value={pessoasBoolean}
            onChange={(value) => handleChange("pessoasBoolean", value)}
          />

          <AlertMessage
            severity="info"
            title='"Há animais próximos ao incêndio?"'
          />
          <YesNoField
            value={animaisBoolean}
            onChange={(value) => handleChange("animaisBoolean", value)}
          />

          <AlertMessage
            severity="info"
            title='"Há residências próximas ao incêndio?"'
          />
          <YesNoField
            value={residenciasBoolean}
            onChange={(value) => handleChange("residenciasBoolean", value)}
          />
          ...
          {pessoasBoolean || animaisBoolean || residenciasBoolean ? (
            <AlertMessage severity="warning" title="Informe ao Solicitante:">
              ...
              {pessoasBoolean &&
                " Afaste todas as pessoas para um local seguro."}
              {animaisBoolean &&
      ...
      {!emergencial && (
        <Grid>
          ...
          <YesNoField
            value={origemBoolean}
            onChange={(value) => handleChange("origemBoolean", value)}
          />
          {origemBoolean && (
            <Grid>
          ...
          />
          <YesNoField
            value={irEstradaBoolean}
            onChange={(value) => handleChange("irEstradaBoolean", value)}
          />
          <AlertMessage severity="warning" title="Informe ao Solicitante:">
            {irEstradaBoolean

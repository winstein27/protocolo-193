...
export const CidadeSelect = (props) => {
  ...
  const cidades = cidadesData[props.uf]
    ? Object.keys(cidadesData[props.uf])
    : [];
...
export const UnidadesTable = (props) => {
  ...
  const unidades = cidadesData[props.uf][props.cidade]
    ? cidadesData[props.uf][props.cidade]["Unidades"]
    : [];
            ...
            {unidades.map((unidade, index) => (
              <TableRow key={index}>
                ...
                <TableCell>
                  {unidade.Contato}
                  <IconButton
                    onClick={() => handleNumberCopy(`${unidade.Contato}`)}
                    aria-label="copy"
                  >
                    <Tooltip title={copied ? "Copiado!" : ""} placement="top">
                      <FileCopyIcon />
...
export const EmConstrucao = (props) => {
  return (
    <AlertMessage severity="warning" title="Aba em Construção">
      {props.message}
    </AlertMessage>
  );
};
